...
static VOID PipeCommands(PCHAR command1 , PCHAR command2) {
    ...
    bRet = CreateProcess (NULL , command1 , NULL , NULL , TRUE , 0 ,
                          NULL , NULL , &si1 , &pi1);
    DIE(bRet == FALSE , "Create Process");
    ...
    bRet = CreateProcess (NULL , command2 , NULL , NULL , TRUE , 0 ,
                          NULL , NULL , &si2 , &pi2);
    DIE(bRet == FALSE , "Create Process");
 ...
 //   bRes = GetExitCodeProcess (pi1.hProcess , &dwRes);
  //  DIE(bRes == FALSE , "GetExitCode");
   ...
   // bRes = GetExitCodeProcess (pi2.hProcess , &dwRes);
   // DIE(bRes == FALSE , "GetExitCode");
